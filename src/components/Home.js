  ...
  <HomeWrapper>
    <Banner>
      ...
      <Header>
        ...
        <Subtitle>
          From concept to creation, KronicLabz is dedicated to bring your idea,
          to reality. From Blockchain security audits and development, to
          educational courses and project creation and management, there's not
          much we can't help you do.
        </Subtitle>
      </Header>
    </Banner>
    <Section1>
      ...
      <Column>
        ...
        <Description>
          The Web3 space has given birth to a new era of digital technology that
          is changing the way we think about and interact with the world. We are
          committed to providing the best possible service to our customers, and
          to the future of the Web3 space. KronicLabz is continuously pushing
          the boundaries of the blockchain and NFTs in particular as a tool that
          can help shape our futures. We are a team of developers, designers,
          engineers, mothers, and fathers, dedicated to the advancement of the
          Web3.
        </Description>
      </Column>
    </Section1>
    ...
    <Section3>
      ...
      <Column>
        ...
        <Subheading>
          Aside from the creation of NFTs, we have mentored over 250 creatives
          in the NFT space!
        </Subheading>
